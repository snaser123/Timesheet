	...
	<div class="limiter">
		<div class="container-login100"
			...
			<marquee><font color=red>
				...
				<div></div>
				<form class="btn-group" action="applypass.html">
					<button class="btn"></button>
					<input type="submit" class="btn" value="Apply pass">

				</form>

				<form class="btn-group" action="Renewalpass.html">
					<button class="btn"></button>
					<input type="submit" class="btn" value="Renewal Pass">


				</form>
				<form class="btn-group" action="TOPUP.html">
					<button class="btn"></button>
					<input type="submit" class="btn" value="TOP UP">
				</form>
				</div>
			</div>
		</div>
