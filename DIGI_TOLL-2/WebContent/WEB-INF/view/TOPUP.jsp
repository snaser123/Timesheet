	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="post" action="AddWallet.html">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "vehicle no is required">
						...
						<input class="input100" type="text" name="amount" placeholder="add wallet amount" value="123456">
